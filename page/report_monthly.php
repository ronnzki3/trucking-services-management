    ...
    <div class="content-wrapper">
        ...
        <div class="rpm-container">  
                <div class="container-srch" style="width:1200px !important;">                        
                    <a href="report.php?datefr=<?=$date1?>&filter=6"><img src="icons/search.png" style="width:25px;"> Filter Search</a>
                    <a href="report_monthly_print.php?datefr=<?=$date1?>&filter=6"><img src="icons/printpreview.png" style="width:25px;"> Print Preview</a>
                </div>
